...
##  [/Aria.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Aria.Client)
...
## [/Aria](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Aria)

The .NET 6 `/Aria` backend server is required for this App's dynamic functions including the Hello API on the home page
